...
public class ApacheCompressFileUtil {
	...
	public static List<File> unZip(byte[] zipFileBytes, String destDir) throws IOException {
		...
		try {
			is = new ZipArchiveInputStream(new ByteArrayInputStream(zipFileBytes),"GBK");
			...
			while ((entry = is.getNextZipEntry()) != null) {
				if (entry.isDirectory()) {
					...
					try {
						...
						fileNames.add(new File(destDir, entry.getName()));
					} finally {
						IOUtils.closeQuietly(os);
					}
				}
	...
	public static void main(String[] args) throws Exception {
		...
		// System.out.println(unZip("F:\\fileupload\\dna-sample.zip",
		// "F:\\fileupload\\"));
		System.out.println(unTar("F:\\fileupload\\中文test.tar", "F:\\fileupload\\"));

		// System.out.println(unBZip2("F:\\fileupload\\中文test.xml.bz2",
		// "F:\\fileupload\\"));
		// System.out.println(unTarBZip2("F:\\fileupload\\中文test.tar.bz2",
		// "F:\\fileupload\\"));

		// System.out.println(unGZ("F:\\fileupload\\test.xml.gz",
		// "F:\\fileupload\\"));
		// System.out.println(unTarGZ("F:\\fileupload\\all.tar.gz",
		// "F:\\fileupload\\"));
	}
}
...
<@i.tHtml>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">费用类型设置</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row --> 
                	...
                	<div class="col-lg-12"> 
						<div class="panel panel-default">
	                        <div class="panel-body">
	                        	<p>
	                        	<@shiro.hasPermission name="system:expensestype:create">
	                        		<a href="${request.contextPath}/expensestype/create" class="btn btn-default" >新增费用类型</a>
	                            </@shiro.hasPermission>
	                            </p>
...
<script>
	var dataTable_config = {//jquery_datatable插件的默认参数皮质
        ...
        "bServerSide": true,
        "responsive": true,
        "sAjaxSource": "${request.contextPath}/expensestype/j_list",
        ...
        {  aTargets: [0],
            "render": function ( data, type, full, meta ) {
            	var rh = '';
            	<@shiro.hasPermission name="system:expensestype:update">
            	rh += ' <a href="${request.contextPath}/expensestype/'+data+'/update">修改</a>';
            	</@shiro.hasPermission> 
            	return rh;
            }
           },

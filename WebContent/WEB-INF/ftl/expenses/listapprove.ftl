...
<@i.tHtml>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">费用报销审批</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row --> 
						...
						<div class="panel panel-default">
	                        <div class="panel-body"> 
	                        	<div class="dataTable_wrapper">
            						...
            						<@shiro.hasPermission name="approve:expenses:approve">
									<p class="form-group">
...
<script type="text/javascript">
	function batchReject() {
		$('#frm-dt_1').attr('action','${request.contextPath}/expensesapprove/batchReject');
		$('#frm-dt_1').submit();
	}
	
	function batchApprove() {
		$('#frm-dt_1').attr('action','${request.contextPath}/expensesapprove/batchApprove');
		$('#frm-dt_1').submit();
	}
...
$(document).ready(function (){
   ...
   var dataTable_config = {//jquery_datatable插件的默认参数皮质
		...
		"bServerSide": true,
		"responsive": true,
		"sAjaxSource": "${request.contextPath}/expensesapprove/j_list",
		...
		"columns" : [ {
				...
				"render": function ( data, type, full, meta ) {
            		var rh = ''; 
            		<@shiro.hasPermission name="approve:expenses:approve">
            		rh += ' <a href="${request.contextPath}/expensesapprove/'+data+'/approve">通过</a>';
            		rh += ' <a href="${request.contextPath}/expensesapprove/'+data+'/reject">拒绝</a>';
            		</@shiro.hasPermission>  
            		return rh;
            	}
			}, {

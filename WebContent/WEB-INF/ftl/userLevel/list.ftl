...
<@i.tHtml>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">员工层级设置</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row --> 
                	...
                	<div class="col-lg-12"> 
						<div class="panel panel-default">
	                        <div class="panel-body">
	                        	<p>
	                        	<@shiro.hasPermission name="system:level:create">
	                        		<a href="${request.contextPath}/level/create" class="btn btn-default" >新增层级</a>
	                            </@shiro.hasPermission>
	                            </p>
...
<script>
	var dataTable_config = {//jquery_datatable插件的默认参数皮质
        ...
        "bServerSide": true,
        "responsive": true,
        "sAjaxSource": "${request.contextPath}/level/j_list",
        ...
        {  aTargets: [0],
            "render": function ( data, type, full, meta ) {
            	...
            	rh += ' <a href="${request.contextPath}/level/'+data+'/update">修改</a>';
            	</@shiro.hasPermission>
            	<@shiro.hasPermission name="system:project:auth">
            	rh += ' <a href="${request.contextPath}/level/'+data+'/cost">成本设定</a>';
            	</@shiro.hasPermission>
            	return rh;
            }
           },

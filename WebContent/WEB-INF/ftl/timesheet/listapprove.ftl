...
<@i.tHtml>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">项目工时审批</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row --> 
						...
						<div class="panel panel-default">
	                        <div class="panel-body"> 
	                        	<div class="dataTable_wrapper">
            						...
            						<@shiro.hasPermission name="approve:timesheet:approve">
									<p class="form-group">
									   <button type="button" class="btn btn-primary" onclick="javascript:batchApprove();">批量通过</button>
									   
									   <button type="button" class="btn btn-primary" onclick="javascript:batchReject();">批量拒绝</button>
									</p>  
									</@shiro.hasPermission>
									</form>
...
<script type="text/javascript">
	function batchReject() {
		$('#frm-dt_1').attr('action','${request.contextPath}/timesheetapprove/batchReject');
		$('#frm-dt_1').submit();
	}
	
	function batchApprove() {
		$('#frm-dt_1').attr('action','${request.contextPath}/timesheetapprove/batchApprove');
		$('#frm-dt_1').submit();
	}
...
$(document).ready(function (){
   ...
   var dataTable_config = {//jquery_datatable插件的默认参数皮质
		...
		"bServerSide": true,
		"responsive": true,
		"sAjaxSource": "${request.contextPath}/timesheetapprove/j_list",
		...
		"columns" : [ {
				...
				"render": function ( data, type, full, meta ) {
            		var rh = ''; 
            		<@shiro.hasPermission name="approve:timesheet:approve">
            		rh += ' <a href="${request.contextPath}/timesheetapprove/'+data+'/approve">通过</a>';
            		rh += ' <a href="${request.contextPath}/timesheetapprove/'+data+'/reject">拒绝</a>';
            		</@shiro.hasPermission>  
            		return rh;
            	}
			}, {
